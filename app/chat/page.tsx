      ...
      <footer className="bg-white border-t p-4 md:p-6">
        <div className="max-w-4xl mx-auto flex gap-4">
          ...
          <button
            onClick={handleSend}
            disabled={loading}
            className={`send-btn-ripple ${loading ? "bg-gray-400" : "bg-blue-600 hover:bg-blue-700"} text-white rounded-xl px-6 flex items-center justify-center transition shadow-md`}
          >
            <Send size={20} />
          </button>
        </div>
